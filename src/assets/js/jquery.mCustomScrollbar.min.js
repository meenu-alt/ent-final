  ...
  (ie = "function" == typeof define && define.amd),
    ...
    (h = function (t) {
      ...
      (t.autoDraggerLength =
        ...
        (t.autoExpandScrollbar =
          !(e.inArray(t.theme, a) > -1) && t.autoExpandScrollbar),
        (t.scrollButtons.enable =
          !(e.inArray(t.theme, n) > -1) && t.scrollButtons.enable),
        (t.autoHideScrollbar =
    ...
    (_ = function () {
      ...
      if (o.advanced.autoExpandHorizontalScroll && "y" !== o.axis) {
        ...
        (2 !== o.advanced.autoExpandHorizontalScroll && i > n.parent().width())
    ...
    (S = function () {
      var t = e(this).data(a),
        ...
        l = [
          ...
          Math.round(r[0] * i[0].parent().height()),
          parseInt(i[1].css("min-width")),
          Math.round(r[1] * i[1].parent().width()),
        ],
        c = s && l[1] < l[0] ? l[0] : l[1],
        d = s && l[3] < l[2] ? l[2] : l[3];
      i[0]
    ...
    (y = function () {
      var t = e(this).data(a),
        ...
        s = n[0].scrollWidth;
      return (
        l > i && (i = l), s > r && (r = s), [i > o.height(), r > o.width()]
      );
    }),
    (B = function () {
      var t,
      ...
      Q(n),
        (("x" !== r.axis && !i.overflowed[0]) ||
          ("y" === r.axis && i.overflowed[0])) &&
          (c[0].add(s).css("top", 0), G(n, "_resetY")),
        (("y" !== r.axis && !i.overflowed[1]) ||
          ("x" === r.axis && i.overflowed[1])) &&
          ((t = o = 0),
          "rtl" === i.langDir &&
            ((t = l.width() - s.outerWidth(!1)),
        ...
        .bind("mousemove." + s, function (e) {
          if (!t && o && f()) {
            ...
            n > 0 && n < u.height() && s > 0 && s < u.width()
              ? l.step && h("off", null, "stepped")
              : ("x" !== r.axis &&
                  i.overflowed[0] &&
                  (n < 0 ? h("on", 38) : n > u.height() && h("on", 40)),
                "y" !== r.axis &&
                  i.overflowed[1] &&
                  (s < 0 ? h("on", 37) : s > u.width() && h("on", 39)));
          }
        })
      ...
      function d(a, i) {
        if ((Q(t), !z(t, a.target))) {
          ...
          ("y" === u && !o.overflowed[0]) ||
            ...
            G(t, (m - v * h).toString(), { dir: u, dur: d }));
        }
      }
    }),
    (R = new Object()),
          ...
          case "keyup":
            ...
            if (
              ...
              if (
                ...
                G(t, h.toString(), { dir: f, scrollEasing: "mcsEaseInOut" });
              }
            } else
              (35 !== r && 36 !== r) ||
                e(document.activeElement).is(d) ||
                ...
                ("yx" === n.axis && o.overflowed[1] && !o.overflowed[0])
                  ...
                  : ((f = "y"),
                    (h =
                      35 === r ? Math.abs(c.height() - s.outerHeight(!1)) : 0)),
                G(t, h.toString(), { dir: f, scrollEasing: "mcsEaseInOut" }));
        }
        function m(e, a) {
          ...
          0 !== o.parents("html").length
            ? (r[0].autoUpdate = setTimeout(function () {
                return i.advanced.updateOnSelectorChange &&
                  ((n.poll.change.n = c()), n.poll.change.n !== n.poll.change.o)
                  ? ((n.poll.change.o = n.poll.change.n), void f(3))
                  ...
                  ? ((n.poll.size.o = n.poll.size.n), void f(1))
    ...
    (G = function (t, o, n) {
      ...
      if (
        ...
        "_resetY" !== o ||
          i.contentReset.y ||
          (B("onOverflowYNone") && r.callbacks.onOverflowYNone.call(t[0]),
          (i.contentReset.y = 1)),
        "_resetX" !== o ||
          i.contentReset.x ||
          (B("onOverflowXNone") && r.callbacks.onOverflowXNone.call(t[0]),
          (i.contentReset.x = 1)),
        "_resetY" !== o && "_resetX" !== o)
      ) {
        if (
          ((!i.contentReset.y && t[0].mcs) ||
            !i.overflowed[0] ||
            (B("onOverflowY") && r.callbacks.onOverflowY.call(t[0]),
            (i.contentReset.x = null)),
          (!i.contentReset.x && t[0].mcs) ||
            !i.overflowed[1] ||
            (B("onOverflowX") && r.callbacks.onOverflowX.call(t[0]),
            (i.contentReset.x = null)),
          r.snapAmount)
        ) {
          var m =
        ...
        _[1] < 0 || (0 === _[0] && 0 === _[1])
          ...
          ? (_ = [x[0], x[1]])
          : (_[0] = -_[0]),
          t[0].mcs || (k(), B("onInit") && r.callbacks.onInit.call(t[0])),
          clearTimeout(d[0].onCompleteTimeout),
          J(p[0], g, Math.round(_[1]), s[1], n.scrollEasing),
          (!i.tweenRunning &&
            ((0 === v && _[0] >= 0) || (v === x[0] && _[0] <= x[0]))) ||
            J(d[0], g, Math.round(_[0]), s[0], n.scrollEasing, n.overwrite, {
              onStart: function () {
                n.callbacks &&
                  n.onStart &&
                  !i.tweenRunning &&
                  (B("onScrollStart") &&
                    (k(), r.callbacks.onScrollStart.call(t[0])),
                  (i.tweenRunning = !0),
                  C(p),
                  (i.cbOffsets = T()));
              },
              onUpdate: function () {
                n.callbacks &&
                  n.onUpdate &&
                  B("whileScrolling") &&
                  (k(), r.callbacks.whileScrolling.call(t[0]));
              },
              onComplete: function () {
                if (n.callbacks && n.onComplete) {
                  ...
                  d[0].onCompleteTimeout = setTimeout(function () {
                    B("onScroll") && (k(), r.callbacks.onScroll.call(t[0])),
                      B("onTotalScroll") &&
                        _[1] >= x[1] - b &&
                        i.cbOffsets[0] &&
                        (k(), r.callbacks.onTotalScroll.call(t[0])),
                      B("onTotalScrollBack") &&
                        _[1] <= y &&
                        i.cbOffsets[1] &&
                        (k(), r.callbacks.onTotalScrollBack.call(t[0])),
                      (i.tweenRunning = !1),
                      (d[0].idleTimer = 0),
                      C(p, "hide");
                  }, e);
      ...
      function T() {
        return [
          r.callbacks.alwaysTriggerOffsets || v >= x[0] + w,
          r.callbacks.alwaysTriggerOffsets || v <= -S,
        ];
      }
      function k() {
          ...
          mcsInView:
            ...
            function (t) {
              ...
              if (i.length)
                return (
                  (o = i.parent()),
                  (a = [i[0].offsetTop, i[0].offsetLeft])[0] + ae(n)[0] >= 0 &&
